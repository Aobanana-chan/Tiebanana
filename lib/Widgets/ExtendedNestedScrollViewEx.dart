...
///修改过的extended_nested_scroll_view
...
class _ExtendedNestedScrollCoordinator extends _NestedScrollCoordinator {
  ...
  /// When [ExtendedNestedScrollViewEx]'s body has [TabBarView]/[PageView] and
...
/// to expand.
///
/// [ExtendedNestedScrollViewEx] solves this problem by providing custom
...
///
/// This example shows a [ExtendedNestedScrollViewEx] whose header is the combination of a
...
/// {@end-tool}
///
/// ## [SliverAppBar]s with [ExtendedNestedScrollViewEx]s
///
/// Using a [SliverAppBar] in the outer scroll view, or [headerSliverBuilder],
/// of a [ExtendedNestedScrollViewEx] may require special configurations in order to work
/// as it would if the outer and inner were one single scroll view, like a
/// [CustomScrollView].
///
/// ### Pinned [SliverAppBar]s
///
/// A pinned [SliverAppBar] works in a [ExtendedNestedScrollViewEx] exactly as it would in
...
///
/// This works naturally in a [ExtendedNestedScrollViewEx], as the pinned [SliverAppBar]
...
///
/// In order to float the outer, use [ExtendedNestedScrollViewEx.floatHeaderSlivers]. When
...
/// {@tool sample --template=stateless_widget_material}
///
/// This simple example shows a [ExtendedNestedScrollViewEx] whose header contains a
...
///
/// It is possible with a [ExtendedNestedScrollViewEx] to perform just the snapping
/// animation without floating the app bar in and out. By not using the
/// [ExtendedNestedScrollViewEx.floatHeaderSlivers], the app bar will snap in and out
/// without floating.
///
...
/// implemented in a [ExtendedNestedScrollViewEx]. These widgets take any overlapping
...
/// e.g [ExtendedNestedScrollViewEx.floatHeaderSlivers], the [SliverAppBar] will animate
...
/// Currently, [ExtendedNestedScrollViewEx] does not support simultaneously floating and
...
/// Currently, [ExtendedNestedScrollViewEx] does not support stretching the outer
...
/// ```
/// {@end-tool}
class ExtendedNestedScrollViewState extends State<ExtendedNestedScrollViewEx> {
  ...
  void initState() {
    ...
    widget.initStateCallback?.call(this);
  }
  ...
  @override
  void didUpdateWidget(ExtendedNestedScrollViewEx oldWidget) {
