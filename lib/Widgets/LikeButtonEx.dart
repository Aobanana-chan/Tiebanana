...
class LikeButtonEx extends StatefulWidget {
  const LikeButtonEx(
      {Key? key,
      this.size = 30.0,
      this.likeBuilder,
  ...
  @override
  State<StatefulWidget> createState() => LikeButtonStateEx();
}

class LikeButtonStateEx extends State<LikeButtonEx>
  ...
  @override
  void didUpdateWidget(LikeButtonEx oldWidget) {
    _isLiked = widget.isLiked;
    _likeCount = widget.likeCount;
    _preLikeCount = _likeCount;
